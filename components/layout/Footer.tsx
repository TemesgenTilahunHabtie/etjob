  ...
  return (
    <footer className="relative overflow-hidden bg-slate-950 text-slate-300 border-t border-slate-800">
      ...
      <div className="relative mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 pt-16 pb-12">
        ...
        {/* Bottom Section: Copyright & Highly Visible Colorful Social Buttons */}
        <div className="flex flex-col items-center justify-between gap-4 pt-8 sm:flex-row text-xs text-slate-400">
          <p>© 2026 ETJob. All rights reserved.</p>

          {/* Vibrant & Distinct Colorful Social Badges */}
          <div className="flex items-center gap-3">
            {/* Telegram - Bright Sky Blue Pill */}
            <a
              href="https://t.me"
              target="_blank"
              rel="noopener noreferrer"
              aria-label="Telegram"
              className="flex items-center gap-2 rounded-xl bg-sky-500/20 px-3.5 py-2 text-xs font-bold text-sky-300 border border-sky-500/30 transition-all hover:bg-sky-500 hover:text-white hover:border-sky-500 hover:shadow-lg hover:shadow-sky-500/25 active:scale-95"
            >
            ...
            {/* LinkedIn - Professional Royal Blue Pill */}
            <a
              href="https://linkedin.com"
              target="_blank"
              rel="noopener noreferrer"
              aria-label="LinkedIn"
              className="flex items-center gap-2 rounded-xl bg-blue-600/20 px-3.5 py-2 text-xs font-bold text-blue-300 border border-blue-500/30 transition-all hover:bg-blue-600 hover:text-white hover:border-blue-600 hover:shadow-lg hover:shadow-blue-600/25 active:scale-95"
            >
              <svg className="h-4 w-4 fill-current" viewBox="0 0 24 24">
            ...
            {/* Facebook - Vibrant Indigo Pill */}
            <a
              href="https://facebook.com"
              target="_blank"
              rel="noopener noreferrer"
              aria-label="Facebook"
              className="flex items-center gap-2 rounded-xl bg-indigo-600/20 px-3.5 py-2 text-xs font-bold text-indigo-300 border border-indigo-500/30 transition-all hover:bg-indigo-600 hover:text-white hover:border-indigo-600 hover:shadow-lg hover:shadow-indigo-600/25 active:scale-95"
            >
              <svg className="h-4 w-4 fill-current" viewBox="0 0 24 24">
